...
export const CHANNELS: ChannelRecord[] = [
    { channelKey: "Hits1", channelName: "SiriusXM Hits 1", channelNumber: "2", superCategory: "Music", genre: "Pop", description: "Today's biggest pop hits", packages: "All" },
    { channelKey: "BPM", channelName: "BPM", channelNumber: "51", superCategory: "Music", genre: "Electronic/Dance", description: "Non-stop dance and EDM", packages: "All" },
    ...
    { channelKey: "OutlawCountry", channelName: "Outlaw Country", channelNumber: "60", superCategory: "Music", genre: "Country", description: "Outlaw and alternative country", packages: "All" },
    { channelKey: "TheHighway", channelName: "The Highway", channelNumber: "55", superCategory: "Music", genre: "Country", description: "New country hits", packages: "All" },
    { channelKey: "AltNation", channelName: "Alt Nation", channelNumber: "36", superCategory: "Music", genre: "Alternative Rock", description: "Alternative rock hits", packages: "All" },
    { channelKey: "LiquidMetal", channelName: "Liquid Metal", channelNumber: "40", superCategory: "Music", genre: "Heavy Metal", description: "Metal and hard rock", packages: "Premier+" },
    { channelKey: "Octane", channelName: "Octane", channelNumber: "37", superCategory: "Music", genre: "Hard Rock", description: "Hard rock and metal", packages: "All" },
    { channelKey: "HowardStern", channelName: "Howard Stern", channelNumber: "100", superCategory: "Howard Stern", genre: "Talk", description: "Howard Stern Show channels", packages: "Premier+" },
    ...
    { channelKey: "ClassicVinyl", channelName: "Classic Vinyl", channelNumber: "26", superCategory: "Music", genre: "Classic Rock", description: "Classic rock from the 60s-80s", packages: "All" },
    { channelKey: "Premier1", channelName: "SiriusXM Premier", channelNumber: "1", superCategory: "Music", genre: "Pop", description: "Premium curated pop hits", packages: "Premier+" },
    { channelKey: "PopRocks", channelName: "Pop Rocks", channelNumber: "14", superCategory: "Music", genre: "Pop", description: "Pop and rock crossover", packages: "All" },
    { channelKey: "HipHopNation", channelName: "Hip-Hop Nation", channelNumber: "44", superCategory: "Music", genre: "Hip-Hop", description: "Hip-hop and rap", packages: "All" },
    { channelKey: "Chill", channelName: "Chill", channelNumber: "53", superCategory: "Music", genre: "Electronic", description: "Chill and ambient electronic", packages: "All" },
];
